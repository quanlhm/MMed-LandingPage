...
import Img1 from "../../assets/images/study-card-1.png";
import Img2 from "../../assets/images/study-card-2.png";
import Img3 from "../../assets/images/study-card-3.png";
import Img4 from "../../assets/images/study-card-4.png";
import Img5 from "../../assets/images/study-card-5.png";
import Img6 from "../../assets/images/study-card-6.png";
import Img7 from "../../assets/images/study-card-7.png";
import Img8 from "../../assets/images/study-card-8.png";
import Img9 from "../../assets/images/study-card-9.png";
    ...
    <>
      <section className="study" id="study">
        <div className="study-container">
          <div className="study-title heading weight--700 size--40">
            Học Thông Minh Hơn Với AI - Chuẩn Y Khoa Quốc Tế
          </div>
          <div className="study-content text weight--700 size--24">
